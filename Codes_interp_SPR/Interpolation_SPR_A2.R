...
spr_interp_pr_A2_10 <- foreach(i = 1:length(n_spatterns_pr), .combine = rbind,
...
save(spr_interp_pr_A2_10, file = "Projet_1/Interpolation_finale_3/Simulations_SPR/Region_A2/spr_interp_pr_A2_10.RData")
...
spr_interp_tasmin_A2_10 <- foreach(i = 1:length(n_spatterns_tasmin), .combine = rbind,
                            .packages = c("bigmemory", "bigstatsr")) %dopar% {
  # Perform SPR for each n_spatterns
...
# Save the results in appropriate folder
save(spr_interp_tasmin_A2_10, file = "Projet_1/Interpolation_finale_3/Simulations_SPR/Region_A2/spr_interp_tasmin_A2_10.RData")
...
spr_interp_tasmax_A2_10 <- foreach(i = 1:length(n_spatterns_tasmax), .combine = rbind,
                            .packages = c("bigmemory", "bigstatsr")) %dopar% {
  # Perform SPR for each n_spatterns
...
# Save the results in appropriate folder
save(spr_interp_tasmax_A2_10, file = "Projet_1/Interpolation_finale_3/Simulations_SPR/Region_A2/spr_interp_tasmax_A2_10.RData")
...
prop_NA_pr <- 0.40
n_spatterns_pr <- custom_round(n_pr * prop_NA_pr)
spr_interp_pr_A2_30 <- foreach(i = 1:length(n_spatterns_pr), .combine = rbind,
                            .packages = c("bigmemory", "bigstatsr")) %dopar% {
  # Perform SPR for each n_spatterns
  number <- n_spatterns_pr
  interp_spr <- spr_interp(data_rcm_grid = data_pr_grid, n_spatterns = number,
...
# Save the results in appropriate folder
save(spr_interp_pr_A2_30, file = "Projet_1/Interpolation_finale_3/Simulations_SPR/Region_A2/spr_interp_pr_A2_30.RData")
...
prop_NA_tasmin <- 0.25
n_spatterns_tasmin <- custom_round(n_tasmin * prop_NA_tasmin)
spr_interp_tasmin_A2_30 <- foreach(i = 1:length(n_spatterns_tasmin), .combine = rbind,
                            .packages = c("bigmemory", "bigstatsr")) %dopar% {
  # Perform SPR for each n_spatterns
  number <- n_spatterns_tasmin
  interp_spr <- spr_interp(data_rcm_grid = data_tasmin_grid, n_spatterns = number,
...
# Save the results in appropriate folder
save(spr_interp_tasmin_A2_30, file = "Projet_1/Interpolation_finale_3/Simulations_SPR/Region_A2/spr_interp_tasmin_A2_30.RData")
...
prop_NA_tasmax <- 0.30
n_spatterns_tasmax <- custom_round(n_tasmax * prop_NA_tasmax)
spr_interp_tasmax_A2_30 <- foreach(i = 1:length(n_spatterns_tasmax), .combine = rbind,
                            .packages = c("bigmemory", "bigstatsr")) %dopar% {
  # Perform SPR for each n_spatterns
  number <- n_spatterns_tasmax
  interp_spr <- spr_interp(data_rcm_grid = data_tasmax_grid, n_spatterns = number,
...
# Save the results in appropriate folder
save(spr_interp_tasmax_A2_30, file = "Projet_1/Interpolation_finale_3/Simulations_SPR/Region_A2/spr_interp_tasmax_A2_30.RData")
...
prop_NA_pr <- 0.40
n_spatterns_pr <- custom_round(n_pr * prop_NA_pr)
spr_interp_pr_A2_50 <- foreach(i = 1:length(n_spatterns_pr), .combine = rbind,
                            .packages = c("bigmemory", "bigstatsr")) %dopar% {
  # Perform SPR for each n_spatterns
  number <- n_spatterns_pr
  interp_spr <- spr_interp(data_rcm_grid = data_pr_grid, n_spatterns = number,
...
# Save the results in appropriate folder
save(spr_interp_pr_A2_50, file = "Projet_1/Interpolation_finale_3/Simulations_SPR/Region_A2/spr_interp_pr_A2_50.RData")
...
prop_NA_tasmin <- 0.30
n_spatterns_tasmin <- custom_round(n_tasmin * prop_NA_tasmin)
spr_interp_tasmin_A2_50 <- foreach(i = 1:length(n_spatterns_tasmin), .combine = rbind,
                            .packages = c("bigmemory", "bigstatsr")) %dopar% {
  # Perform SPR for each n_spatterns
  number <- n_spatterns_tasmin
  interp_spr <- spr_interp(data_rcm_grid = data_tasmin_grid, n_spatterns = number,
...
# Save the results in appropriate folder
save(spr_interp_tasmin_A2_50, file = "Projet_1/Interpolation_finale_3/Simulations_SPR/Region_A2/spr_interp_tasmin_A2_50.RData")
...
prop_NA_tasmax <- 0.30
n_spatterns_tasmax <- custom_round(n_tasmax * prop_NA_tasmax)
spr_interp_tasmax_A2_50 <- foreach(i = 1:length(n_spatterns_tasmax), .combine = rbind,
                            .packages = c("bigmemory", "bigstatsr")) %dopar% {
  # Perform SPR for each n_spatterns
  number <- n_spatterns_tasmax
  interp_spr <- spr_interp(data_rcm_grid = data_tasmax_grid, n_spatterns = number,
...
# Save the results in appropriate folder
save(spr_interp_tasmax_A2_50, file = "Projet_1/Interpolation_finale_3/Simulations_SPR/Region_A2/spr_interp_tasmax_A2_50.RData")
...
prop_NA_pr <- 0.20
n_spatterns_pr <- custom_round(n_pr * prop_NA_pr)
spr_interp_pr_A2_70 <- foreach(i = 1:length(n_spatterns_pr), .combine = rbind,
                            .packages = c("bigmemory", "bigstatsr")) %dopar% {
  # Perform SPR for each n_spatterns
  number <- n_spatterns_pr
  interp_spr <- spr_interp(data_rcm_grid = data_pr_grid, n_spatterns = number,
...
# Save the results in appropriate folder
save(spr_interp_pr_A2_70, file = "Projet_1/Interpolation_finale_3/Simulations_SPR/Region_A2/spr_interp_pr_A2_70.RData")
...
prop_NA_tasmin <- 0.25
n_spatterns_tasmin <- custom_round(n_tasmin * prop_NA_tasmin)
spr_interp_tasmin_A2_70 <- foreach(i = 1:length(n_spatterns_tasmin), .combine = rbind,
                            .packages = c("bigmemory", "bigstatsr")) %dopar% {
  # Perform SPR for each n_spatterns
  number <- n_spatterns_tasmin
  interp_spr <- spr_interp(data_rcm_grid = data_tasmin_grid, n_spatterns = number,
...
# Save the results in appropriate folder
save(spr_interp_tasmin_A2_70, file = "Projet_1/Interpolation_finale_3/Simulations_SPR/Region_A2/spr_interp_tasmin_A2_70.RData")
...
prop_NA_tasmax <- 0.30
n_spatterns_tasmax <- custom_round(n_tasmax * prop_NA_tasmax)
spr_interp_tasmax_A2_70 <- foreach(i = 1:length(n_spatterns_tasmax), .combine = rbind,
                            .packages = c("bigmemory", "bigstatsr")) %dopar% {
  # Perform SPR for each n_spatterns
  number <- n_spatterns_tasmax
  interp_spr <- spr_interp(data_rcm_grid = data_tasmax_grid, n_spatterns = number,
...
# Save the results in appropriate folder
save(spr_interp_tasmax_A2_70, file = "Projet_1/Interpolation_finale_3/Simulations_SPR/Region_A2/spr_interp_tasmax_A2_70.RData")
...
prop_NA_pr <- 0.40
n_spatterns_pr <- custom_round(n_pr * prop_NA_pr)
spr_interp_pr_A2_90 <- foreach(i = 1:length(n_spatterns_pr), .combine = rbind,
                            .packages = c("bigmemory", "bigstatsr")) %dopar% {
  # Perform SPR for each n_spatterns
  number <- n_spatterns_pr
  interp_spr <- spr_interp(data_rcm_grid = data_pr_grid, n_spatterns = number,
...
# Save the results in appropriate folder
save(spr_interp_pr_A2_90, file = "Projet_1/Interpolation_finale_3/Simulations_SPR/Region_A2/spr_interp_pr_A2_90.RData")
...
prop_NA_tasmin <- 0.45
n_spatterns_tasmin <- custom_round(n_tasmin * prop_NA_tasmin)
spr_interp_tasmin_A2_90 <- foreach(i = 1:length(n_spatterns_tasmin), .combine = rbind,
                            .packages = c("bigmemory", "bigstatsr")) %dopar% {
  # Perform SPR for each n_spatterns
  number <- n_spatterns_tasmin
  interp_spr <- spr_interp(data_rcm_grid = data_tasmin_grid, n_spatterns = number,
...
# Save the results in appropriate folder
save(spr_interp_tasmin_A2_90, file = "Projet_1/Interpolation_finale_3/Simulations_SPR/Region_A2/spr_interp_tasmin_A2_90.RData")
...
prop_NA_tasmax <- 0.40
n_spatterns_tasmax <- custom_round(n_tasmax * prop_NA_tasmax)
spr_interp_tasmax_A2_90 <- foreach(i = 1:length(n_spatterns_tasmax), .combine = rbind,
                            .packages = c("bigmemory", "bigstatsr")) %dopar% {
  # Perform SPR for each n_spatterns
  number <- n_spatterns_tasmax
  interp_spr <- spr_interp(data_rcm_grid = data_tasmax_grid, n_spatterns = number,
...
# Save the results in appropriate folder
save(spr_interp_tasmax_A2_90, file = "Projet_1/Interpolation_finale_3/Simulations_SPR/Region_A2/spr_interp_tasmax_A2_90.RData")
